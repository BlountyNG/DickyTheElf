...
public class QuestAnimationTriggers : MonoBehaviour
{
	...
	void Awake()
	{
		m_room = GetComponentInChildren<RoomComponent>() != null;
		m_character = GetComponentInChildren<CharacterComponent>() != null;		
	}
	...
	{		
		...
		// Try calling function in room script
		if ( sent == false && m_room )
		{		
			
			RoomComponent comp = GetComponentInParent<RoomComponent>();	
		...
		// Try calling function in character script
		...
		// Try calling function in global script
		if ( sent == false )
		{		
