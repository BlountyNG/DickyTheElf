...
public partial class QuestCamera : ICamera
{
	...
	public void SetCharacterToFollow(ICharacter character) { m_characterToFollow = character.ScriptName;  if ( m_instance != null ) m_instance.Snap(); }
	...
	// Public Functions
	//
	public void Shake(float intensity, float duration = 0.0f, float falloff = 0.15f)
	{
