		...
		*/
		return ( type.IsClass 
				&& (type == typeof(GameObject)
					...
					//|| type.IsSubclassOf(typeof(Coroutine))
					|| type.IsSubclassOf(typeof(MulticastDelegate)) // Eg: Action, Action<object>, Action<object, object> etc etc
					// || type == typeof(List<AnimationClip>) - NB: Lists of other objects may be stored save/restored, but their content wouldn't be. may lead to errors?
