...
public class RoomComponent : MonoBehaviour 
{
	...
	public AnimationClip GetAnimation(string animName) { return m_animations.Find(item=>string.Equals(animName, item.name, System.StringComparison.OrdinalIgnoreCase));  }
