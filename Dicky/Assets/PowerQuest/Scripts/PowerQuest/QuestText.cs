...
public class QuestText : MonoBehaviour 
{
	...
	[Tooltip("If text doesn't fit on screen, shrink it's wrap width to this (0 = disabled)")]
	...
	public int OrderInLayer { get{ return m_orderInLayer; } set{ m_orderInLayer = value; } }
	...
	{ 
		if ( m_outline != null && (m_outline.m_directions != outline.m_directions) )
		{
