...
{	
	...
	public static partial class C
	{
		...
		// Add section to dialog script- only appears in voice script
		public static void Section( string dialog ) {/*No op- just for editor*/}

		// Makes current player walk to what was clicked (Shortcut to PowerQuest.Get.GetPlayer().WalkToClicked())
		public static Coroutine WalkToClicked() { return C.Player.WalkToClicked(); }
		// Makes current player face what was clicked (Shortcut to PowerQuest.Get.GetPlayer().FaceClicked())
	...
	public static partial class R
	{
		...
		public static bool EnteredFromEditor { get { return Application.isEditor && (PowerQuest.Get.GetPlayer().LastRoom == null /* || PowerQuest.Get.GetPlayer().LastRoom.ScriptName == "Title"*/); } }
