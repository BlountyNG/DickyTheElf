...
{	
	...
	public void WalkToBG( float x, float y, bool anywhere = false )
	{
		WalkToBG(new Vector2(x,y), anywhere);
	}

	public void WalkToBG( Vector2 pos, bool anywhere = false )
	{
	...
	public void WalkToBG(IQuestClickableInterface clickable, bool anywhere = false)
	{
		if ( clickable != null )
		{
	...
	public Coroutine StopWalking() { if ( m_instance!= null ) m_instance.StopWalk(); return null; }	// Stops walking on the spot
	
	// Non-blocking versions of facing functions
	public void FaceDownBG(bool instant = false) { FaceBG(eFace.Down, instant); }
	public void FaceUpBG(bool instant = false) { FaceBG(eFace.Up, instant); }
	public void FaceLeftBG(bool instant = false) { FaceBG(eFace.Left, instant); }
	public void FaceRightBG(bool instant = false) { FaceBG(eFace.Right, instant); }
	...
	public void FaceBG(Vector2 location, bool instant = false) { FaceBG(location,instant); }
	public void FaceClickedBG(bool instant = false) { FaceClickedBG(instant); }
	public void FaceAwayBG(bool instant = false) { FaceAwayBG(instant); }
	public void FaceDirectionBG(Vector2 directionV2, bool instant = false) { FaceDirectionBG(directionV2,instant); }
	...
	void StartSay(string line, int id = -1)
	{		
